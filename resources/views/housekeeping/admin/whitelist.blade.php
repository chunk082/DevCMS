...
<div class="container mt-4">
    <h2 class="mb-3">Client Whitelist</h2>

    <!-- Form to add new IP (at the top) -->
    <div class="card mb-4">
        <div class="card-body">
            <h4 class="card-title">Add New IP</h4>
            <form action="{{ route('housekeeping.admin.whitelist.store') }}" method="POST">
                @csrf
                <div class="form-row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ip->reason ?? 'N/A' }}</td>
                        <td>
                            <form action="{{ route('housekeeping.whitelist.destroy', $ip->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
